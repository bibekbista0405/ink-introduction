      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
          ...
          >
            ...
            <span className="text-sm font-bold text-primary tracking-widest uppercase">The Next-Gen Anonymous Experience</span>
          </motion.div>
          ...
          >
            <span>🎈 {isStickerParty ? "Party Mode ON!" : "Drop Stickers"}</span>
          </motion.button>
        </div>
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter leading-[1.1] mb-8 max-w-5xl text-dark flex flex-col items-center">
          <AnimatedText text="Whisper in secret." splitBy="character" className="block text-center" delay={0.1} />
          <AnimatedText 
            text="Express in bold." 
            splitBy="character"
        ...
        >
          Send and receive anonymous confessions, genuine Q&As, and playful secrets. Safe, encrypted, and designed for meaningful human curiosity.
        </motion.p>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="relative z-10">Enter INK Web</span> 
      ...
      {quality >= 3 && !isMobile && (
        <>
          <motion.div style={floatingLeftStyle} className="absolute top-1/4 left-[5%] lg:left-[10%] hidden md:flex z-20 will-change-transform">
            <Tooltip content="Pure unconditional love 💖" position="right">
